package com.sohu.common.algorithm;
 ...
 */
public class SuperTableShardingAlgorithm extends AbstractShardingAlgorithm  implements PreciseShardingAlgorithm<String>
{
