...
//    public SqlSessionFactory testSqlSessionFactory(@Qualifier("jdkDataSource") DataSource dataSource) throws Exception {
...
////    public DataSourceTransactionManager testTransactionManager(@Qualifier("jdkDataSource") DataSource dataSource) {
